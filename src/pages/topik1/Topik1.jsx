...
import Topik1Test from "./Topik1Test";

export default function Topik1() {
  return (
    <Routes>
      <Route path="/" element={<Wrappar />} />
      <Route path="/test" element={<Topik1Test />} />
    </Routes>
  );
}
          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <section className="mb-8 bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                bo'lgan asosiy muloqot qobiliyatlarini baholaydi va ikkita
                asosiy bo'limga bo'linadi: Tinglash (듣기) va O'qish(읽기).
              </p>
              <ul className="list-disc list-inside text-gray-600 mb-4">
                ...
                <li>
                  Maksimum ball: 200 ball (듣기: 100 ball, 읽기: 100 ball)
                </li>
              </ul>
            </section>
